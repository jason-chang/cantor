...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/cantor/cantor)


## Have a Question

If you have questions about how to use Laradock, please direct your questions to the discussion on [Gitter](https://gitter.im/Laradock/cantor). If you believe your question could help others, then consider opening an [Issue](https://github.com/cantor/cantor/issues) (it will be labeled as `Question`) And you can still seek help on Gitter for it.
...
opening an [Issue](https://github.com/cantor/cantor/issues).
...
## Want a Feature
You can request a new feature by submitting an [Issue](https://github.com/cantor/cantor/issues) (it will be labeled as `Feature Suggestion`). If you would like to implement a new feature then consider submitting a Pull Request yourself.
...
> The site will be auto-generated in the `docs/` folder by [Travis CI](https://travis-ci.org/cantor/cantor/).
...
* Search [GitHub](https://github.com/cantor/cantor/pulls) for an open or closed Pull Request that relates to your submission. You don't want to duplicate efforts.
...
* In GitHub, send a pull request to `cantor:master`.
