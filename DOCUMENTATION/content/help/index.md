...
Join the chat room on [Gitter](https://gitter.im/Laradock/cantor) and get help and support from the community.
...
You can as well can open an [issue](https://github.com/cantor/cantor/issues) on Github (will be labeled as Question) and discuss it with people on [Gitter](https://gitter.im/Laradock/cantor).
...
As stated on [#749](https://github.com/cantor/cantor/issues/749#issuecomment-419652646), Already fixed，just set `CHANGE_SOURCE` to false.
